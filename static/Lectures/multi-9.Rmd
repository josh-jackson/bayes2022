...
##Note that this below won't work
  geom_line(aes(y = .epred, group = levels(record_id)))
...
```{r}
 melsm %>% 
  ...
  stat_lineribbon(aes(y = .epred, group = P_A.std, color = P_A.std),  .width = 0, show.legend = F) 
```
