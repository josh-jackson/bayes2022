...
Note that {ggist} is a package that is loaded with {tidybayes}. It was spun off of the original {tidybayes} to assist with frequentist model visualization too. 
...
We can even go and easily plot these values we calculated
...
.pull-left[How can we use this distribution? If a model is a good fit we should be able to generate data that resemble the data we observed. 
